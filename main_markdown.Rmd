...
DoHeatmap(data1_seurat, features = VariableFeatures(data1_seurat)[1:200], cells = 1:197, 
                           size = 4, angle = 90) 
...
```{r}
# Create a subset of your data1_seurat object containing only the cluster labels and expression of top variable genes
top10_genes_data <- subset(data1_seurat, select = c("seurat_clusters", top10_genes))

# Create the violin plot
VlnPlot(object = top10_genes_data, features = top_var_genes, group.by = "seurat_clusters")

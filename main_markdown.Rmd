...
Dimensionality reduction of the expression matrix is performed to identify the sources of heterogeneity and visualize the high-dimensional dataset. It is going to be performed with three different times with three different methods. 

...
```{r}
ggplot(cell_joint_probabilities, aes(x = cell_id, y = joint_prob)) +
  geom_density2d_filled(aes(fill = stat(density)), alpha = 0.5) +
  scale_fill_gradient(low = "blue", high = "white", name = "Density") +
  labs(x = "Cell ID", y = "Joint Probability", title = "Density Contour of Joint Probabilities")
